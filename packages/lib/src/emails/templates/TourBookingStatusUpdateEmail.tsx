...
import { SendTourBookingStatusUpdateEmailArgs } from "../sender.types";

type TourBookingStatusUpdateEmailProps = SendTourBookingStatusUpdateEmailArgs;

export const TourBookingStatusUpdateEmail = ({
  user,
  booking,
}: TourBookingStatusUpdateEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Your tour booking status update - Irfan Cars & Tours</Preview>
      <Tailwind>
        <Body className="bg-[#f6f9fc] font-sans">
          <Container className="bg-white mx-auto py-5 pb-12 mb-16 px-4">
            ...
            <Text className="text-[#333] text-base leading-7">
              We are writing to inform you that the status of your tour booking (ID: {booking.id}) has been updated.
            </Text>
...
export default TourBookingStatusUpdateEmail;
